...
export const CreateMessage = ({setConversation}) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
     ...
     const createdMessage = await createMessage(userId, friendId, messageId)
  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-6">
      <form className="flex flex-col gap-4">
        ...
        <button className="rounded-full border bg-red-600 px-3 py-3 font-semibold text-white hover:bg-red-700">
          Message
        </button>
      </form>
    </div>
