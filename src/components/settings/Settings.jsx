          ...
          <section className="border-t border-gray-100 p-6 dark:border-stone-800">
            ...
            <div className="flex items-center justify-between rounded-lg border border-gray-100 p-4 dark:border-stone-800">
              ...
              <button
                ...
                className="rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400"
              >
                Edit Profile
              </button>
            </div>
